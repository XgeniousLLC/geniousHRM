...
export default function ShiftCreate() {
    const { data, setData, post, processing, errors } = useForm({
        ...
        break_minutes: '30', color: '#3b82f6', is_active: true,
    });
        ...
        <AppLayout>
            <div className="max-w-xl mx-auto space-y-5">
                <nav className="flex items-center gap-1.5 text-sm text-slate-500">
                    ...
                    <ChevronRight size={14} />
                    <span className="text-slate-900 dark:text-white font-medium">Add Shift</span>
                </nav>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Add Shift</h1>
