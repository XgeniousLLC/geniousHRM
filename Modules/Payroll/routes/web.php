...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('/payroll/components', SalaryComponentController::class)->parameters(['components' => 'component'])->except(['show']);
    Route::resource('/payroll/structures', SalaryStructureController::class)->parameters(['structures' => 'structure'])->except(['show']);
