...
class Employee extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\EmployeeSalary::class)->orderByDesc('effective_date');
    }

    public function latestSalary()
    {
        return $this->hasOne(\App\Models\EmployeeSalary::class)->latestOfMany('effective_date');
    }
